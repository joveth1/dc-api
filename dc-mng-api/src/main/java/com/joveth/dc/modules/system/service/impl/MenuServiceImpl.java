...
import com.joveth.dc.modules.system.domain.vo.MenuMetaVo;
import com.joveth.dc.modules.system.domain.vo.MenuVo;
import com.joveth.dc.exception.BadRequestException;
import com.joveth.dc.exception.EntityExistException;
import com.joveth.dc.modules.system.repository.MenuRepository;
...
public class MenuServiceImpl implements MenuService {
    ...
    public MenuDto findById(long id) {
        Menu e = menuRepository.findById(id).orElseGet(Menu::new);
        ValidationUtil.isNull(e.getId(),"Menu","id",id);
        return new MenuDto(
                e.getId(),
                e.getType(),
                e.getPermission(),
    ...
    public List<MenuDto> findByUser(Long currentUserId) {
        ...
        return menus.stream().map(e -> new MenuDto(
                e.getId(),
                e.getType(),
                e.getPermission(),
                e.getTitle(),
    ...
    @Override
    public List<MenuDto> getMenuDtos(Long pid) {
        List<Menu> menus;
