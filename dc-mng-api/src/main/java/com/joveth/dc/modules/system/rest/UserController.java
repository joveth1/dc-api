...
import com.joveth.dc.config.RsaProperties;
import com.joveth.dc.modules.system.domain.Dept;
import com.joveth.dc.modules.system.service.DataService;
import com.joveth.dc.modules.system.domain.User;
import com.joveth.dc.exception.BadRequestException;
import com.joveth.dc.modules.system.domain.vo.UserPassVo;
import com.joveth.dc.modules.system.service.DeptService;
...
import com.joveth.dc.modules.system.service.UserService;
import com.joveth.dc.utils.enums.CodeEnum;
...
public class UserController {
    ...
    public ResponseEntity<Object> queryUser(UserQueryCriteria criteria, Pageable pageable){
        ...
        // 数据权限
        List<Long> dataScopes = dataService.getDeptIds(userService.findByName(SecurityUtils.getCurrentUsername()).toDto());
