...
public class DictServiceImpl implements DictService {
    ...
    public Map<String, Object> queryAll(DictQueryCriteria dict, Pageable pageable) {
        ...
        return PageUtil.toPage(page.map(Dict::toDto));
    }

    @Override
    public List<DictDto> queryAll(DictQueryCriteria dict) {
        List<DictDto> list = dictRepository.findAll((root, query, cb) -> QueryHelp.getPredicate(root, dict, cb))
                .stream().map(Dict::toDto).collect(Collectors.toList());
        return list;
    }
