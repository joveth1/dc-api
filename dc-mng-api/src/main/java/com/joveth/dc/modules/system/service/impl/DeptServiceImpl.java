...
import com.joveth.dc.modules.system.service.dto.DeptDto;
import com.joveth.dc.modules.system.service.dto.DeptQueryCriteria;
import com.joveth.dc.utils.*;
import com.joveth.dc.modules.system.repository.DeptRepository;
...
public class DeptServiceImpl implements DeptService {
    ...
    public List<DeptDto> getSuperior(DeptDto deptDto, List<Dept> depts) {
        if (deptDto.getPid() == null) {
            ...
            return depts.stream().map(e -> new DeptDto(
                    e.getId(),
                    e.getName(),
                    e.getEnabled(),
                    e.getDeptSort(),
